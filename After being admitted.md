زمانیکه استاد بهتون خبر قبولی رو میده(یا ایمیل میزنه یا تلفن)، یه زمانی رو مشخص میکنه که شما هم نظر نهاییتون رو بدین (که این زمان قابل چونه زدنه). 
...
یکی از مهم ترین ایمیل هایی که طی این مدت دریافت کردم،
 بعد از حدودا یک هفته از قبولی، ایمیلی از طرف  Immigration Service Desk. طی ایمیل توضیح میدن که به چه ویزایی نیاز داریم و اونا اقدامات لازم رو انجام میدن.
 ...
 با فاصله حدود ده روز از اعلام قبولی، از ایمیل bernoulli.office@rug.nl که متعلق به دفتر برنولیست(انستیتویی که قراره توش کار کنم برنولی بود) ایمیلی مبنی بر امضای فرم TSPارسال میشه. پیش از اون با استاد روی این فرم کار کردین، توی این فرم جزییات کارتون شرح داده شده. فرم مهمی هست و خوبه کامل بخونیدش و امضاش کنید.
